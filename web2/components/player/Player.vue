...
const songRequest = parseInt(
    decodeURIComponent(params.get("song") || "Song Not Found"),
);
const versionRequest = decodeURIComponent(params.get("version") || "original")
    .trim()
    .toLowerCase();
...
const bgColorName = computed(
    () =>
        colorOptions.filter(
            (x) => x.color === bodyBackgroundColor,
        )[0].name || colorOptions[0].name,
);
...
const processedLines = computed(() => {
    ...
    const outcome = jsonMappingContent.value.map((line) => {
        ...
        const validDuration = mainTotalDuration > 0 ? mainTotalDuration : 3.0;
...
const isKiai = (line, phraseIndex) => {
    return line.text[phraseIndex].kiai;
};

const isBackgroundKiai = (line, phraseIndex) => {
    return line.background_voice.text[phraseIndex].kiai;
};
</script>
...
<template>
            ...
            >
                ...
                >
                    ...
                    >
                            ...
                            <span
                                ...
                                :class="{
                                    active:
                                        ...
                                        index < jsonMappingContent.length - 1,
                                    kiai: isKiai(line, phraseIndex),
                                }"
                            >
                                <span v-if="t.pronounciation">
                                    ...
                                    <span v-else-if="enablePronounciation">
                                        <ruby>
                                            {{ t.phrase }}
                                            <rp>(</rp>
                                            <rt>{{ t.pronounciation }}</rt>
                                            <rp>)</rp>
                                        </ruby>
                                    </span>
                        ...
                        >
                            <span
                                v-for="(bvt, phraseIndex) in line
                                    .background_voice.text"
                                ...
                                :delay="line.delay[phraseIndex] * 100"
                                :style="
                                    getBackgroundPhraseStyle(index, phraseIndex)
                                "
                                :class="{
                                    active:
                                        isActivePhrase(
                                        ...
                                        index < jsonMappingContent.length - 1,
                                    kiai: isBackgroundKiai(line, phraseIndex),
                                }"
                            >
    ...
    <div
        id="main-ui-section"
        class="flex flex-col justify-center items-center gap-2 md:right-0 bottom-0 fixed md:p-4 w-full px-4 p-2 md:w-[30%] rounded-xl"
    >
        <div class="hidden md:flex flex-row">
            <button
                class="rounded-2xl bg-gray-500 outline-black outline-2"
                id="controller-panel-switch-md"
                aria_label="顯示或隱藏控制介面"
                title="顯示或隱藏控制介面"
            >
                <div class="flex flex-row p-1">
                    <div
                        class="material-icons p-2 select-none"
                        id="controller-panel-switch-icon-md"
                    >
                        keyboard_arrow_down
                    </div>
                    <div
                        id="controller-panel-switch-state-md"
                        class="mt-2 px-2"
                    >
                        CLOSE
                    </div>
        ...
        >
            <div
                v-if="currentSong.translation?.available == true"
                class="p-4 flex flex-col items-center gap-2 bg-[#231f1f] opacity-90 rounded-xl w-fit"
            >
                <div class="text-xl font-bold text-center text-teal-300">
                    {{ translationText }}
                    <div class="mt-1 text-sm text-center text-teal-500">
                        {{ backgroundTranslationText }}
                    </div>
                </div>
            ...
            <div class="flex md:hidden">
                ...
                >
                    <div class="flex flex-row p-1">
                        ...
                        <div
                            id="controller-panel-switch-state-below-md"
                            class="mt-2 px-2"
                        >
                            CLOSE
                        </div>
            ...
            >
                ...
                <div class="text-center items-center mr-2 mb-2">
                    ...
                    >
                        <a
                            :href="
                                ALBUM_GOOGLE_LINK_BASE + currentSong.album.link
                            "
                ...
                >
                    ...
                    <div
                        ...
                        v-for="(contributor, index) in currentSong.credits
                            .performance"
                    >
                        <div
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <div class="flex flex-row gap-2">
                            ...
                            <button
                                ...
                                @click="
                                    copyToClipboard(currentSongURI, '歌曲連結')
                                "
                            >
                                <div class="sm:hidden">
