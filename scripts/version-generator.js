...
try {
    ...
    const buildDate = new Date(Date.now() + 28800000)
        ...
        .slice(0, 10)
        .replace(/-/g, "");
    // 3600.000 * 8 = 28800.000, to ensure UTC+8.

    const content = `// auto-generated by version-generator.js, don't edit
export const COMMIT_ID = "${commitHash}";
