<template>
    <nav
        class="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-4 py-3 bg-black/30 backdrop-blur-md border-b border-white/10"
    >
        <!-- 返回歌單（手機圓形按鈕） -->
        <div
            class="bg-[#4ac2d7] outline-2 outline-cyan-800 rounded-full hover:bg-sky-300 transition-colors duration-200"
        >
            <a href="/song-select" aria-label="返回歌曲選擇">
                <svg
                    height="50"
                    width="50"
        ...
        >
            ...
            >
               ...
               11.965 11.965 0 0 1 .3-8.5s2.7-.9 8.8 3.3a30.873 30.873 0 0 1 8-1.1
               30.292 30.292 0 0 1 8 1.1c6.1-4.1 8.8-3.3 8.8-3.3
